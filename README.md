...
Forms / UI
django-smart-selects (chained dropdowns)
Server
Gunicorn + WhiteNoise (static files)
Config
dj-database-url (12-factor DATABASE_URL)
Deployment
Docker, Docker Compose, Railway, Render
Project Structure
.
...
Health check landing / session picker
/accounts/healthcheck/<session_id>/
Voting wizard
/accounts/summary/
Personal results summary
/accounts/yourprofile/team_summary/
Team-level results
/accounts/yourprofile/
